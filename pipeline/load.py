    ...
    def run(self):
        ...
        try:
            ...
            product_category_query = read_sql_file(
                file_path = f'{DIR_LOAD_QUERY}/stg.category_name.sql'
            )
        ...
        try:
            ...
            try:
                ...
                # Load product category name tables
                ...
                logging.info(f"LOAD All Tables To olist_dwh - SUCCESS")
                
            except Exception:
                logging.error(f"LOAD All Tables To olist_dwh - FAILED")
            ...
            try:
                # List query
                load_stg_queries = [geolocation_query, product_category_query, customers_query, sellers_query, products_query,
